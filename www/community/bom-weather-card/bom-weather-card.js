...
// #####
  ...
  slotValue(slot,value){
    ...
    var possibleToday = this.config.alt_possibleToday ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="alt-possibleToday">${this._hass.states[this.config.alt_possibleToday].state}</span></li>` : this.config.entity_possibleToday : ``;
    var possibleTomorrow = this.config.alt_possibleTomorrow ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="alt-pop_possibleTomorrow">${this._hass.states[this.config.alt_pop_possibleTomorrow].state}</span></li>` : this.config.entity_pop_possibleTomorrow ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="pop-possibleTomorrow-text">${Math.round(this._hass.states[this.config.entity_pop_possibleTomorrow].state)}</span> %<span id="pop-possibleTomorrow-text">${intensity}</span></li>` : ``;
