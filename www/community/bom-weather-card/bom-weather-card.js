...
// #####
  ...
  slotValue(slot,value){
    ...
    var pop_possibleToday = this.config.alt_pop_possibleToday ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="alt-pop_possibleToday">${this._hass.states[this.config.alt_pop_possibleToday].state}</span></li>` : this.config.entity_pop_possibleToday ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="pop-possibleToday-text">${Math.round(this._hass.states[this.config.entity_pop_possibleToday].state)}</span> %<span id="pop-possibleToday-text">${intensity}</span></li>` : ``;
    var pop_possibleTomorrow = this.config.alt_pop_possibleTomorrow ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="alt-pop_possibleTomorrow">${this._hass.states[this.config.alt_pop_possibleTomorrow].state}</span></li>` : this.config.entity_pop_possibleTomorrow ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="pop-possibleTomorrow-text">${Math.round(this._hass.states[this.config.entity_pop_possibleTomorrow].state)}</span> %<span id="pop-possibleTomorrow-text">${intensity}</span></li>` : ``;
    ...
    switch (value){
      case 'pop': return pop;
	  case 'possibleToday': return pop_possibleToday;
	  case 'possibleTomorrow': return pop_possibleTomorrow;
