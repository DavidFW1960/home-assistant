...
// #####
  ...
  slotValue(slot,value){
    ...
    var possibleToday = this.config.alt_possibleToday ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="alt-possibleToday">${this._hass.states[this.config.alt_possibleToday].state}</span></li>` : this.config.entity_possibleToday ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="possibleToday-text">${Math.round(this._hass.states[this.config.entity_possibleToday].state)}</span> %<span id="possibleToday-text">${possibleToday}</span></li>` : ``;
    var possibleTomorrow = this.config.alt_possibleTomorrow ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="alt-possibleTomorrow">${this._hass.states[this.config.alt_possibleTomorrow].state}</span></li>` : this.config.entity_possibleTomorrow ? html`<li><span class="ha-icon"><ha-icon icon="mdi:weather-rainy"></ha-icon></span><span id="possibleTomorrow-text">${Math.round(this._hass.states[this.config.entity_pop_possibleTomorrow].state)}</span> %<span id="possibleTomorrow-text">${possibleTomorrow}</span></li>` : ``;
...
// Optional Entities    
      ...
      if (this.config.entity_possibleToday && !this.config.alt_possibleToday) { root.getElementById("possibleToday-text").textContent = ` - ${this._hass.states[this.config.entity_possibleToday].state} ${this.getUOM('precipitation')}` }
      if (this.config.entity_possibleTomorrow && !this.config.alt_possibleTomorrow) { root.getElementById("possibleTomorrow-text").textContent = ` - ${this._hass.states[this.config.entity_possibleTomorrow].state} ${this.getUOM('precipitation')}` }
...
// Alt Text
      ...
      if (this.config.alt_possibleToday) { root.getElementById("alt-possibleToday").textContent = `${this._hass.states[this.config.alt_possibleToday].state}` }
      if (this.config.alt_possibleTomorrow) { root.getElementById("alt-possibleTomorrow").textContent = `${this._hass.states[this.config.alt_possibleTomorrow].state}` }
